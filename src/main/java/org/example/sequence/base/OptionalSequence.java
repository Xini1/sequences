 ...
 */
public final class OptionalSequence<T> implements Sequence<T> {

    private final Sequence<T> original;

    public OptionalSequence(Optional<T> optional) {
        original = optional.<Sequence<T>>map(SingleElementSequence::new)
